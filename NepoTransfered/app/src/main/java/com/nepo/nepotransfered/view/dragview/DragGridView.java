        ...
        setOnItemLongClickListener(new OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (isDrag()) {
                    ...
                    //取出Adapter设置的背景图，移动时设置
                    Object tag = dragViewGroup.getTag();
                    TransferTypeModel item = null;
                    if (tag != null) {
                        item = (TransferTypeModel) tag;
                    }
                    //TextView dragTextView = (TextView) dragViewGroup.findViewById(R.id.title_tv);
...
//                        dragViewGroup.setBackgroundColor(defaultDragBgColor);
                            //移动时设置为与原背景相同
                            dragViewGroup.setBackgroundResource(item.getTransferBgResourceId());
                        } else {
//                        dragViewGroup.setBackgroundColor(android.R.color.transparent);
                        }
...
//        }else{
//            System.out.println("-- gridview else");
//        }
    }
