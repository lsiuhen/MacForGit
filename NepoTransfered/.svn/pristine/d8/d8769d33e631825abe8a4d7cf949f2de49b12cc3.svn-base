package com.nepo.nepotransfered.view.circleview;
...
public class ProgressCircle extends View {
    ...
    private float mSectionRatio = 2.0f;
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            int progress = attributes.getInteger(R.styleable.SeekCircle_uiprogress, 0);
            ...
            mRingBias = attributes.getFloat(R.styleable.SeekCircle_ringBias, 0.12f);
            mSectionRatio = attributes.getFloat(R.styleable.SeekCircle_sectionRatio, 35.0f);
        } finally {
            attributes.recycle();
        }
    }
